 ...
 *
 */
class MultiplicationPlugin implements Plugin<Project> {
    ...
    static final String TASK_INSTALL_NAME = "installApps"
    static final String TASK_DIST_ZIP_NAME = "distZip"
    static final String TASK_DIST_TAR_NAME = "distTar"

    private Project project
    private MultiplicationPluginConvention pluginConvention
    ...
    private void addPluginConvention() {
        pluginConvention = new MultiplicationPluginConvention(project)
    ...
    private void addCreateScriptsTask() {
        def startScripts = project.tasks.create(TASK_START_SCRIPTS_NAME, MultiCreateStartScripts)
        ...
        startScripts.conventionMapping.mainClassNames = { pluginConvention.mainClassNames }
        ...
        startScripts.conventionMapping.exeNameTransform = { pluginConvention.exeNameTransform }
    }
